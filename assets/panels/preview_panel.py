...
def setup_preview_panel(app, parent_frame):
    """
    Configurar panel de vista previa CORREGIDO y compatible
    """
    
    # Header de vista previa LIMPIO
    preview_header = ttk.Frame(parent_frame)
...
def export_professional_docs(app):
    """Importar función desde editor_panel para mantener compatibilidad"""
    try:
        from panels.editor_panel import export_professional_docs as epd
        epd(app)
    except ImportError:
        messagebox.showwarning("Exportar", "Función de exportación no disponible")
...
def update_preview_improved(app):
    ...
    # MODO 3: COLUMNAS - ALINEACIÓN PERFECTA CORREGIDA
        ...
        header = "Nombre".ljust(50) + "Estado".ljust(10) + "Markdown"
        ...
        def print_columnas(nid, indent=0):
            ...
            name_part = name.ljust(50)  # 50 caracteres fijos para nombre
            status_part = status.ljust(10)  # 10 caracteres fijos para estado CON SEPARACIÓN
