def on_select(self, event):
        ...
        if node_id in self.node_data:
            ...
            # Cargar contenido en los nuevos editores
            ...
            if hasattr(self, 'code_text'):
                ...
                if hasattr(self, 'update_code_line_numbers'):
                    self.root.after_idle(self.update_code_line_numbers)# carpetatree/core/tree_app.py
...
class TreeAppV4:
    ...
    def load_initial_project(self):
        """Inicializar proyecto solo con carpeta Root"""
    ...
    def show_search_dialog(self):
        SearchDialog(self.root, self.text)
    ...
    def insert_markdown(self, prefix, suffix=""):
        try:
            ...
            text.insert(tk.INSERT, f"{prefix}{selection}{suffix}")
        except tk.TclError:
            text.insert(tk.INSERT, f"{prefix}{suffix}")
    ...
    def change_font_size(self, size):
        ...
        if hasattr(self, 'preview_text'):
            self.preview_text.configure(font=("Consolas", size))
